...
LogisticRegressionModel = LogisticRegression(penalty='l2',solver='sag',C=1.0,random_state=55)
...
# print('Predicted Value for LogisticRegressionModel is : ' , y_train[:10])
